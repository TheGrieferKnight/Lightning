...
-- ---------- Champion mastery ----------
CREATE TABLE
  IF NOT EXISTS champion_mastery (
    puuid TEXT NOT NULL,
    champion_id INTEGER NOT NULL,
    champion_name TEXT NOT NULL,
    champion_level INTEGER NOT NULL,
    champion_points INTEGER NOT NULL,
    chest_granted INTEGER NOT NULL CHECK (chest_granted IN (0, 1)),
    ...
    mark_required_for_next_level INTEGER NOT NULL,
    champion_season_milestone INTEGER NOT NULL,
    next_season_milestone_json TEXT, -- store NextSeasonMilestonesDto as JSON
    tokens_earned INTEGER NOT NULL,
    milestone_grades_json TEXT, -- store Vec<String> as JSON
    icon TEXT NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS dashboard_matches (
...
CREATE TABLE
  IF NOT EXISTS match_metadata_participants (
    match_id TEXT NOT NULL,
    puuid TEXT NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS match_team_objectives (
    match_id TEXT NOT NULL,
    team_id INTEGER NOT NULL,
