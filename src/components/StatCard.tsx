  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5">
        <div className={`p-4 rounded-xl ${colorClasses.bg} group-hover:scale-110 transition-transform duration-200`}>
      ...
      <h3 className="text-3xl font-extrabold text-white mb-1 tracking-tight drop-shadow-lg">{value}</h3>
